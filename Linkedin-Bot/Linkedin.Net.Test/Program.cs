...
namespace Linkedin.Net.Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var linkedin = new Linkedin(new Estructuras.Login { email= "josemaleon44@gmail.com", password= "LMZ23jamas" },true);
            //var linkedin = new Linkedin(new Estructuras.Login { email = "henocasael487@gmail.com", password = "mancha0708" }, true);
            //var reslut = linkedin.AddConnection(publicIdPaladin,"Hola guapo, vengo por tu hija").GetAwaiter().GetResult();
            ...
            //var linkedin = new Linkedin(new Estructuras.Login { email = "henocasael487@gmail.com", password = "mancha0708" });
